...
/**
 * EC-LabManager Configuration List.
 */
    ...
    extends ListBase
{
    ...
    private final LabManagerConfigList m_configList;
    ...
    public ConfigurationList()
    {
        ...
        super("ecgc", "Lab Manager Configurations", "All Configurations");
        m_configList = new LabManagerConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        Loader loader = new LabManagerConfigListLoader(m_configList, this,
                new ChainedCallback() {
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.setProjectName("/plugins/EC-LabManager/project");
        request.setProcedureName("DeleteLMConnection");
    ...
    private void loadList()
    {
        ...
        if (!m_configList.isEmpty()) {
            ...
            // noinspection HardCodedStringLiteral
            listTable.addHeaderRow(true, "Connection Name", "Server", "Port");
        }
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            // Port
            String configPort      = m_configList.getConfigPort(configName);
            Label  configPortLabel = new Label(configPort);
            ...
            ClickHandler dch = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the Lab Manager connection '"
                            + configName + "'?") {
            ...
            listTable.addRow(configNameLabel, configServerLabel,
                configPortLabel, actions);
        }
    ...
    private void waitForJob(final String jobId)
    {
        CgiRequestProxy     cgiRequestProxy = new CgiRequestProxy(
                getPluginName(), "labmanagerMonitor.cgi");
                        ...
                        if (responseString.startsWith("Success")) {
                            ...
                            SimpleErrorBox      error      = getUIFactory()
                                    .createSimpleErrorBox(
                                        "Error occurred during connection deletion: "
                                        + responseString);
