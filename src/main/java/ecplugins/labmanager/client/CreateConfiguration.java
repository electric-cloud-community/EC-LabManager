...
/**
 * Create LabManager Configuration.
 */
    ...
    extends InternalFormBase
{
    ...
    public CreateConfiguration()
    {
        ...
        super("New Lab Manager Connection", "Lab Manager Configurations");
    ...
    @Override protected void load()
    {
        ...
        loader.setCustomEditorPath("/plugins/EC-LabManager"
                + "/project/ui_forms/LabManagerCreateConfigForm");
        loader.load();
        clearStatus();
    }
    ...
    @Override protected void submit()
    {
        ...
        request.setProcedureName("CreateLMConnection");
                        ...
                        if (responseString.startsWith("Success")) {
                            ...
                            SimpleErrorBox      error      = getUIFactory()
                                    .createSimpleErrorBox(
                                        "Error occurred during connection creation: "
                                        + responseString);
